...
//Procedimento que recebe duas vari�veis que apontam para
//dois arrays e executa a regra do combinador D: c f g x => c (f x) (g x),
//copiando os argumentos do array1 para o array2.
...
//Procedimento que recebe duas vari�veis que apontam para
//dois arrays e executa a regra do combinador E: c f g x => c f (g x),
//copiando os argumentos do array1 para o array2.
...
//Procedimento que recebe duas vari�veis que apontam para
//dois arrays e executa a regra do combinador F: c f g x => c (f x) g,
//copiando os argumentos do array1 para o array2.
...
//Procedimento que recebe duas vari�veis que apontam para
//dois arrays e executa a regra do combinador Y: x (Y x),
//copiando os argumentos do array1 para o array2.
